...
/**
 * Data Transfer Object (DTO) for inserting a new student into the system.
 */
public class StudentInsertDTO {
     ...
     */
    public StudentInsertDTO(Integer id, String firstName, String lastName, Gender gender, Date dateOfBirth) {
        this.id = id;
